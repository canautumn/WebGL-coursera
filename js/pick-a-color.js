/*
    With this version the color can be changed programmatically by
    $(function() {
        $(".pick-a-color").pickAColor();
    
        $("input#color-picker").pickAColor({method:"val", value:"dfda0d"});
    });

    See:
    https://github.com/lauren/pick-a-color/issues/65
...
;(function ($) {
    ...
    $.fn.pickAColor = function (options) {
      ...
      // class .pick-a-color-applied to avoid multiple pick-a-color
      // see http://jsfiddle.net/frangin2003/gkw9waac/ for bug demo
      if (! $(this).hasClass("pick-a-color-applied")) {
          $(this).addClass("pick-a-color-applied");
